<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-xl rounded-2xl border border-gray-200">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-6 flex flex-col md:flex-row items-center gap-4">
                        ...
                        <form action="{{ route('players.index') }}" method="GET" class="relative w-full md:flex-1">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                                            <div class="flex items-center justify-center space-x-3">
                                                                                            ...
                                                                                            <button onclick="openEditModal({{ $player->toJson() }})" class="text-indigo-600 hover:text-indigo-900" title="Editar">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                                                    </svg>
                                                </button>

                                                 <button onclick="openViewModal({{ $player->toJson() }})" class="text-green-600 hover:text-green-900" title="Ver Credencial">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                                ...
                                                <form action="{{ route('players.destroy', $player) }}" method="POST" onsubmit="return confirm('¿Estás seguro de que quieres eliminar este jugador?');" class="inline">
                                                    @csrf @method('DELETE')
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm">
                                            ...
                                            @elseif($player->status == 'suspended')
                                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-800">Suspendido ({{ $player->suspension_games }} part.)</span>
                                            @else
                                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-100 text-red-800">Expulsado</span>
                                            @endif
                                        </td>

                                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-500">{{ $player->team->name }}</td>
                                    </tr>
                                @empty
                                    <tr>
                            ...
                            <div id="tab-personal">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div class="md:col-span-2">
                                        <x-input-label for="modal_name" :value="__('Nombre Completo *')" />
                                    ...
                                    <div>
                                        <x-input-label for="modal_rfc" :value="__('RFC')" />
                                        <x-text-input id="modal_rfc" class="block mt-1 w-full focus:border-orange-500 focus:ring-orange-500" type="text" name="rfc" maxlength="13" placeholder="Ej: ABCD123456XYZ" />
                                    </div>

                                    <div>
                                        <x-input-label for="modal_curp" :value="__('CURP *')" />
                                        <x-text-input id="modal_curp" class="block mt-1 w-full focus:border-orange-500 focus:ring-orange-500" type="text" name="curp" maxlength="18" placeholder="18 caracteres" required />
                                    </div>
                                    ...
                                    <div>
                                        <x-input-label for="modal_position" :value="__('Posición')" />
                                        <x-text-input id="modal_position" class="block mt-1 w-full focus:border-orange-500 focus:ring-orange-500" type="text" name="position" placeholder="Ej: Base, Alero" />
                                    </div>

                                    <div>
                                        <x-input-label for="modal_gender" :value="__('Sexo')" />
                                    ...
                                    <div>
                                        <x-input-label for="modal_blood_type" :value="__('Tipo de Sangre')" />
                                    ...
                                    <div>
                                        <x-input-label for="modal_team_id" :value="__('Equipo')" />
                                    ...
                                    <div>
                                        <x-input-label for="modal_status" :value="__('Estatus')" />
                                    ...
                                    <div>
                                        <x-input-label for="modal_image" :value="__('Foto *')" />
                                ...
                                <div class="bg-orange-50 p-4 rounded-lg border border-orange-100">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div class="col-span-1 md:col-span-2">
                                            <x-input-label for="modal_emergency_name" :value="__('Nombre del Contacto')" />
                                            <x-text-input id="modal_emergency_name" class="block mt-1 w-full focus:border-orange-500 focus:ring-orange-500" type="text" name="emergency_contact_name" />
                                        </div>
                                        
                                        <div>
                                            <x-input-label for="modal_emergency_relationship" :value="__('Parentesco')" />
                                            <x-text-input id="modal_emergency_relationship" class="block mt-1 w-full focus:border-orange-500 focus:ring-orange-500" type="text" name="emergency_contact_relationship" placeholder="Ej: Padre, Esposa" />
                                        </div>

                                        <div>
                                            <x-input-label for="modal_emergency_phone" :value="__('Teléfono')" />
                                            <x-text-input id="modal_emergency_phone" class="block mt-1 w-full focus:border-orange-500 focus:ring-orange-500" type="text" name="emergency_contact_phone" placeholder="Ej: 55 1234 5678" />
                                        </div>

                                        <div class="col-span-1 md:col-span-2">
                                            <x-input-label for="modal_emergency_address" :value="__('Dirección')" />
    ...
    <script>
        ...
        function openEditModal(player) {
            ...
            document.getElementById('playerForm').action = '{{ route("players.update", ":id") }}'.replace(':id', player.id);
