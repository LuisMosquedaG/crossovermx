                                ...
                                <div class="flex items-center justify-center w-full md:w-[12%] gap-2 border-b border-gray-100 md:border-b-0 pb-2 md:pb-0">
                                    <div class="flex flex-col items-center text-center w-full">
                                        ...
                                        <div class="flex flex-row gap-1.5 text-[9px] md:text-[10px] text-gray-400 font-semibold mt-0.5 leading-tight">
                                            <span>F: <span class="player-fouls text-gray-600" id="local-{{ $localActivePlayers[$i]->id }}-fouls">{{ $totalFouls }}</span></span>
                                            <span>P: <span class="player-points text-gray-600" id="local-{{ $localActivePlayers[$i]->id }}-points">{{ $s['points'] }}</span></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @endphp
                                ...
                                <div class="flex items-center justify-center w-full md:w-[12%] gap-2 border-b border-gray-100 md:border-b-0 pb-2 md:pb-0">
                                    <div class="flex flex-col items-center text-center w-full">
                                        ...
                                        <span class="text-[9px] md:text-[10px] font-bold text-slate-600 uppercase tracking-wide mt-0 leading-none truncate w-full">
                                            {{ $awayActivePlayers[$i]->name }}
                                        </span>
                                        <!-- Stats PEGADOS -->
                                        <div class="flex flex-row gap-1.5 text-[9px] md:text-[10px] text-gray-400 font-semibold mt-0.5 leading-tight">
                                            <span>F: <span class="player-fouls text-gray-600" id="away-{{ $awayActivePlayers[$i]->id }}-fouls">{{ $totalFouls }}</span></span>
                                            <span>P: <span class="player-points text-gray-600" id="away-{{ $awayActivePlayers[$i]->id }}-points">{{ $s['points'] }}</span></span>
                                        </div>
                                    </div>
                                </div>
