...
<?php endif; ?>
    ...
    <script>
        ...
        async function saveStartingPlayers(event) {
            ...
            if (localSelected < 3 || localSelected > 5 || awaySelected < 3 || awaySelected > 5) {
                alert('Debes seleccionar entre 3 y 5 jugadores para cada equipo.');
                return;
            }
    ...
    </script><?php /**PATH C:\xampp\htdocs\sistemaTorneos\resources\views/tournaments/schedule.blade.php ENDPATH**/ ?>