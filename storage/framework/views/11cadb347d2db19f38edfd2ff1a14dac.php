                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                                            <div class="flex items-center justify-center space-x-2">
                                                ...
                                                <button onclick="openAssignRefereeModal(<?php echo e($game->id); ?>, '<?php echo e($game->referee_id ?? ''); ?>')" class="text-yellow-600 hover:text-yellow-800" title="Asignar Árbitro">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            ...
                                            <?php elseif($game->status === 'finished'): ?>
                                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-800 text-white">Finalizado</span>
                                            <?php else: ?>
...
<?php endif; ?>
    ...
    </script><?php /**PATH C:\xampp\htdocs\sistemaTorneos\resources\views/games/index.blade.php ENDPATH**/ ?>