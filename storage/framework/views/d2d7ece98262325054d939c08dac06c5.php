                                            ...
                                            <div class="space-y-3">
                                                ...
                                                <?php $__currentLoopData = $tData['top_scorers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scorer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="flex items-center justify-between bg-white rounded-xl p-3 border border-gray-100 shadow-sm">
                                                        ...
                                                        <span class="text-sm font-black text-orange-600 bg-orange-50 px-2.5 py-1 rounded-lg"><?php echo e($scorer['points']); ?> pts</span>
                                                    </div>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>
                                        <?php endif; ?>
                                                        ...
                                                        <div class="flex items-center gap-3">
                                                            ...
                                                            <div class="flex items-center gap-2">
                                                                <?php if($team['team_logo']): ?>
                                                                    <img src="<?php echo e(asset('storage/' . $team['team_logo'])); ?>" class="h-6 w-6 rounded-full object-cover border border-gray-100" onerror="this.style.display='none'">
                                                                <?php else: ?>
                                                                    <div class="h-6 w-6 rounded-full bg-gray-200 flex items-center justify-center text-[10px] font-bold text-gray-500"><?php echo e(substr($team['team_name'], 0, 1)); ?></div>
                                                                <?php endif; ?>
                                                                <span class="text-sm font-bold text-gray-800 truncate w-32 sm:w-40"><?php echo e($team['team_name']); ?></span>
                                                            </div>
                                                        </div>
                                                        <span class="text-xs font-black text-blue-700 bg-blue-50 px-2 py-1 rounded"><?php echo e($team['score']); ?></span>
                                                    </div>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>
                                        <?php endif; ?>
                                                        ...
                                                        <div class="flex items-center justify-between gap-2 py-1">
                                                            ...
                                                            <div class="flex items-center gap-2 w-5/12">
                                                                <?php if($game['local_logo']): ?>
                                                                    <img src="<?php echo e(asset('storage/' . $game['local_logo'])); ?>" class="h-6 w-6 rounded-full object-cover border border-gray-100" onerror="this.style.display='none'">
                                                                <?php else: ?>
                                                                    <div class="h-6 w-6 rounded-full bg-gray-200 flex items-center justify-center text-[10px] font-bold text-gray-500"><?php echo e(substr($game['local_name'], 0, 1)); ?></div>
                                                                <?php endif; ?>
                                                                <span class="text-xs font-bold text-gray-700 truncate w-16 sm:w-20"><?php echo e($game['local_name']); ?></span>
                                                            </div>
                                                            ...
                                                            <div class="flex items-center gap-2 w-5/12 justify-end">
                                                                <span class="text-xs font-bold text-gray-700 truncate w-16 sm:w-20 text-right"><?php echo e($game['away_name']); ?></span>
                                                                <?php if($game['away_logo']): ?>
                                                                    <img src="<?php echo e(asset('storage/' . $game['away_logo'])); ?>" class="h-6 w-6 rounded-full object-cover border border-gray-100" onerror="this.style.display='none'">
                                                                <?php else: ?>
                                                                    <div class="h-6 w-6 rounded-full bg-gray-200 flex items-center justify-center text-[10px] font-bold text-gray-500"><?php echo e(substr($game['away_name'], 0, 1)); ?></div>
                                                                <?php endif; ?>
                                                            </div>
                                                        </div>
                                                    </div>
