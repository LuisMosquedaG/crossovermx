                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                                            <div class="flex items-center justify-center space-x-3">
                                                ...
                                                <button onclick="showTeamsListModal(<?php echo e($tournament->id); ?>, '<?php echo e(addslashes($tournament->name)); ?>')" class="text-orange-600 hover:text-orange-900" title="Ver Equipos Registrados">
